...
<body>
	...
	<script>
		...
		var submitempUrl = "${webRoot}/customer/empHisSearchListByPage?dataStatus="+data_status;
		$(function() {
			initSubmitempTable();
		...
		function initSubmitempTable() {
			$('#submitemp-table').bootstrapTable(
			{
				...
				columns : [{field: '', title: '序号', formatter: function (value, row, index) { return index+1; }},{
					...
					align : 'center',
					valign : 'middle',
					formatter: function (value) {return getProfes(value)}
				}, {
					field : 'company',
					title : '单位名称',
					align : 'center',
					...
					align : 'center',
					valign : 'middle',
					formatter: function (value) {return getWorkUnitIndOwned(value)}
				}, {
					field : 'occaddress',
					title : '单位地址',
					align : 'center',
					...
					align : 'center',
					valign : 'middle',
					formatter: function (value) {return getDuty(value)}
				}, {
					field : 'annualincome',
					title : '年收入',
					align : 'center',
