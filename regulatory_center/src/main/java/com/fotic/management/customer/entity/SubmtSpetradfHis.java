...
@Entity
@Table(name = "RHZX_SUBMT_PER_SPETRADE_HIS")
public class SubmtSpetradfHis {
	...
	public Long getSpecmoney() {
		return specmoney;
	}
	public void setSpecmoney(Long specmoney) {
