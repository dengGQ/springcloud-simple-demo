package com.fotic.it.support.signature.exception;
...
import com.fotic.it.support.signature.exception.commons.IllegalEndPathException;
import com.fotic.it.support.signature.util.ExceptionUtil;
...
public class GlobalExceptionHandler {
    ...
    private String resultOfFail() {
        return ExceptionUtil.resultOf(ResultStatusCodeEnum.REQUEST_EXCEPTION);
    }
}
